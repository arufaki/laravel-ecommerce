                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{Route('jual.edit', $record->id_penjualan)}}" class="btn btn-primary">Edit</a>
                                        </td>
                                        <td>
                                            <form action="{{Route('jual.destroy', $record->id_penjualan)}}" method="POST" onsubmit="return confirm('Yakin Ingin Menghapus ?')">
                                                @csrf
                                                @method('DELETE')

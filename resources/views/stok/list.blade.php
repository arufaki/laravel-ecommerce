                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $record->pajang?? '-' }}</td>
                                        <td><a href="#" data-target="#exampleModalCenter" data-toggle="modal" class="btn btn-success text-white btn-view" data-order-id="{{$record->id_stok}}" data-image="{{$record->image}}"><i class="fas fa-eye" data-></i></a></td>
                                        <td><a href="{{Route('stok.edit', $record->id_stok)}}" class="btn btn-primary">Edit</a>
                                        </td>

                                        <td>
                                            <form action="{{Route('stok.destroy', $record->id_stok)}}" method="POST" onsubmit="return confirm('Yakin Ingin Menghapus ?')">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="cart-body">
                        <img src="" class="fotoBarang" alt="foto-barang" class="rounded">
